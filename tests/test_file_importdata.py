...
class Test(unittest.TestCase):
    ...
    def run_test(self, app, *args):
        ...
        app.root._import_data([op.join(self.path, 'test_data.sqlite')])
        ...
        # test data
        self.assertTrue(op.exists(op.join(self.path, 'test_data.sqlite')))
        conn = sqlite3.connect(op.join(self.path, 'test_data.sqlite'))
        c = conn.cursor()
